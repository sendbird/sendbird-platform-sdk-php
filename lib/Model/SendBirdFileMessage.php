...
/**
 * SendBirdFileMessage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SendBirdFileMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendBird.FileMessage';
    ...
    protected static $openAPITypes = [
        ...
        'message_id' => 'float',
        'message_params' => '\OpenAPI\Client\Model\SendBirdFileMessageParams',
        ...
        'sender' => '\OpenAPI\Client\Model\SendBirdSender',
        'sending_status' => 'string',
        'silent' => 'bool',
        'size' => 'float',
        'thread_info' => '\OpenAPI\Client\Model\SendBirdThreadInfo',
        'thumbnails' => '\OpenAPI\Client\Model\SendBirdThumbnailObject[]',
        'type' => 'string',
        'updated_at' => 'float',
        'url' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'req_id' => null,
        'request_state' => null,
        'requested_mention_user_ids' => null,
        'sender' => null,
        'sending_status' => null,
        'silent' => null,
        'size' => null,
    ...
    protected static $attributeMap = [
        ...
        'requested_mention_user_ids' => 'requestedMentionUserIds',
        'sender' => 'sender',
    ...
    protected static $setters = [
        ...
        'plain_url' => 'setPlainUrl',
        'reactions' => 'setReactions',
        'req_id' => 'setReqId',
        'request_state' => 'setRequestState',
        'requested_mention_user_ids' => 'setRequestedMentionUserIds',
        'sender' => 'setSender',
    ...
    protected static $getters = [
        ...
        'plain_url' => 'getPlainUrl',
        'reactions' => 'getReactions',
        'req_id' => 'getReqId',
        'request_state' => 'getRequestState',
        'requested_mention_user_ids' => 'getRequestedMentionUserIds',
        'sender' => 'getSender',
    ...
    const REQUEST_STATE_NONE = 'none';
    const REQUEST_STATE_PENDING = 'pending';
    const REQUEST_STATE_SUCCEEDED = 'succeeded';
    ...
    {
        return [
            self::REQUEST_STATE_FAILED,
            self::REQUEST_STATE_NONE,
            self::REQUEST_STATE_PENDING,
            self::REQUEST_STATE_SUCCEEDED,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['message_params'] = $data['message_params'] ?? null;
        ...
        $this->container['plain_url'] = $data['plain_url'] ?? null;
        $this->container['reactions'] = $data['reactions'] ?? null;
        $this->container['req_id'] = $data['req_id'] ?? null;
        $this->container['request_state'] = $data['request_state'] ?? null;
        $this->container['requested_mention_user_ids'] = $data['requested_mention_user_ids'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['request_state']) && !in_array($this->container['request_state'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'request_state', must be one of '%s'",
                $this->container['request_state'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets message_params
     *
     * @param \OpenAPI\Client\Model\SendBirdFileMessageParams|null $message_params message_params
     *
     * @return self
     */
    ...
    {
        return $this->container['plain_url'];
    }

    /**
     * Sets plain_url
     *
     * @param string|null $plain_url plain_url
     *
     * @return self
     */
    public function setPlainUrl($plain_url)
    {
        $this->container['plain_url'] = $plain_url;
     ...
     * Sets request_state
     *
     * @param string|null $request_state request_state
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getRequestStateAllowableValues();
        if (!is_null($request_state) && !in_array($request_state, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'request_state', must be one of '%s'",
                    $request_state,
    ...
    /**
     * Gets requested_mention_user_ids
     *
     * @return string[]|null
     */
    public function getRequestedMentionUserIds()
    {
        return $this->container['requested_mention_user_ids'];
    }

    /**
     * Sets requested_mention_user_ids
     *
     * @param string[]|null $requested_mention_user_ids requested_mention_user_ids
     *
     * @return self
     */
    public function setRequestedMentionUserIds($requested_mention_user_ids)
    {
        $this->container['requested_mention_user_ids'] = $requested_mention_user_ids;
     ...
     * Gets sender
     *
     * @return \OpenAPI\Client\Model\SendBirdSender|null
     */
     ...
     * Sets sender
     *
     * @param \OpenAPI\Client\Model\SendBirdSender|null $sender sender
     *
     * @return self
     */
     ...
     * Gets thumbnails
     *
     * @return \OpenAPI\Client\Model\SendBirdThumbnailObject[]|null
     */
     ...
     * Sets thumbnails
     *
     * @param \OpenAPI\Client\Model\SendBirdThumbnailObject[]|null $thumbnails thumbnails
     *
     * @return self
     */
