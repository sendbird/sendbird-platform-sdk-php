...
/**
 * OcFreezeChannelData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OcFreezeChannelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ocFreezeChannelData';
     ...
     * Sets channel_url
     *
     * @param string $channel_url Specifies the URL of the channel to freeze.
     *
     * @return self
     */
     ...
     * Sets freeze
     *
     * @param bool $freeze Determines whether to freeze the channel. (Default: false)
     *
     * @return self
     */
