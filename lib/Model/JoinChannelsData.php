...
/**
 * JoinChannelsData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class JoinChannelsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'joinChannelsData';
     ...
     * Sets bot_userid
     *
     * @param string $bot_userid Specifies the ID of the bot to join the channels.
     *
     * @return self
     */
     ...
     * Sets channel_urls
     *
     * @param string[] $channel_urls Specifies an array of one or more URLs of the channels to join.
     *
     * @return self
     */
