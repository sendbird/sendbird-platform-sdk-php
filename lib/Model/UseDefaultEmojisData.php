...
/**
 * UseDefaultEmojisData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class UseDefaultEmojisData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'useDefaultEmojisData';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['use_default_emoji'] === null) {
            $invalidProperties[] = "'use_default_emoji' can't be null";
        }
     ...
     *
     * @param bool $use_default_emoji Determines whether to use the 7 default emojis initially provided.
     *
     * @return self
     */
