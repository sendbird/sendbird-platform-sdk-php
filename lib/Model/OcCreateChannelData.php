...
class OcCreateChannelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string|null $name Specifies the channel topic, or the name of the channel. The length is limited to 191 characters. (Default: open channel)
     *
     * @return self
     */
     ...
     * Sets cover_url
     *
     * @param string|null $cover_url Specifies the URL of the cover image. The length is limited to 2,048 characters.
     *
     * @return self
     */
     ...
     * Sets is_ephemeral
     *
     * @param bool|null $is_ephemeral Determines whether to preserve the messages in the channel for the purpose of retrieving chat history or not. It set to true, the messages in the channel are not saved in the Sendbird database and the chat history can't be retrieved. (Default: false)
     *
     * @return self
     */
     ...
     * Sets operator_ids
     *
     * @param string[]|null $operator_ids Specifies an array of one or more user IDs to register as operators of the channel. The maximum allowed number of operators per channel is 100. Operators can delete any messages in the channel, and can also receive all messages that have been throttled.<br/><br/>  Operators cannot view messages that have been [moderated by](/docs/chat/v3/platform-api/guides/filter-and-moderation) the domain filter or profanity filter. Only the sender will be notified that the message has been blocked.
     *
     * @return self
     */
     ...
     * Sets operators
     *
     * @param string[]|null $operators (Deprecated) Specifies the string IDs of the users registered as channel operators. Operators can delete any messages in the channel, and can also receive all messages that have been throttled.
     *
     * @return self
     */
