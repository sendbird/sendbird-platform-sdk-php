...
/**
 * UpdateFcmPushConfigurationByIdData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class UpdateFcmPushConfigurationByIdData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateFcmPushConfigurationByIdData';
     ...
     * Sets api_key
     *
     * @param string $api_key Specifies the FCM server key to update.
     *
     * @return self
     */
