...
class OcRegisterOperatorsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets operator_ids
     *
     * @param int[] $operator_ids Specifies an array of one or more IDs of users to register as operators of the channel. The maximum allowed number of operators per channel is 100.
     *
     * @return self
     */
