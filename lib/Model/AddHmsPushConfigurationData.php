...
/**
 * AddHmsPushConfigurationData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class AddHmsPushConfigurationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addHmsPushConfigurationData';
     ...
     * Sets huawei_app_id
     *
     * @param string $huawei_app_id Specifies the unique ID of application registered to the HMS server.
     *
     * @return self
     */
     ...
     *
     * @param string $huawei_app_secret Specifies the secret key allocated to the application.
     *
     * @return self
     */
