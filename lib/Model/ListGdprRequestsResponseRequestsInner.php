...
/**
 * ListGdprRequestsResponseRequestsInner Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class ListGdprRequestsResponseRequestsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listGdprRequestsResponse_requests_inner';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'user_id' => 'string',
        'files' => '\Sendbird\Model\ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile',
        'user_ids' => 'string[]',
     ...
     * Sets files
     *
     * @param \Sendbird\Model\ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile|null $files files
     *
     * @return self
     */
