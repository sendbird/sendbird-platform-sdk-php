...
class CreateChannelMetadataData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets metadata
     *
     * @param object $metadata Specifies a `JSON` object that stores key-value items. The key must not have a comma (,) and its length is limited to 128 characters. The value must be a string and its length is limited to 190 characters. This property can have up to 5 items.
     *
     * @return self
     */
