 ...
 */
class CreateChannelMetadataData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createChannelMetadataData';
     ...
     * Sets channel_url
     *
     * @param string $channel_url Specifies the URL of the channel to store the metadata in.
     *
     * @return self
     */
