 ...
 */
class UpdateMessageByIdData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateMessageByIdData';
     ...
     * Sets message_id
     *
     * @param int $message_id Specifies the unique ID of the message to update.
     *
     * @return self
     */
