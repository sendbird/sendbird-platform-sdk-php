...
/**
 * InlineResponse20068Requests Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20068Requests implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_68_requests';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'user_id' => 'string',
        'files' => '\Sendbird\Model\InlineResponse20063File',
        'user_ids' => 'string[]',
     ...
     * Sets files
     *
     * @param \Sendbird\Model\InlineResponse20063File|null $files files
     *
     * @return self
     */
