...
/**
 * ListGdprRequestsResponseRequests Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class ListGdprRequestsResponseRequests implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listGdprRequestsResponse_requests';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'user_id' => 'string',
        'files' => '\Sendbird\Model\ListDataExportsByMessageChannelOrUserResponseFile',
        'user_ids' => 'string[]',
     ...
     * Sets files
     *
     * @param \Sendbird\Model\ListDataExportsByMessageChannelOrUserResponseFile|null $files files
     *
     * @return self
     */
