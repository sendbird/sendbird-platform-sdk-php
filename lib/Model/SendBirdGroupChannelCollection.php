 ...
 */
class SendBirdGroupChannelCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendBird.GroupChannelCollection';
    ...
    {
        $this->container['channel_list'] = $data['channel_list'] ?? null;
     ...
     * @return self
     */
    public function setChannelList($channel_list)
    {
