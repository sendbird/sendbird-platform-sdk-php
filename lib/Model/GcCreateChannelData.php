...
class GcCreateChannelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_super'] === null) {
            $invalidProperties[] = "'is_super' can't be null";
        }
        ...
        if ($this->container['block_sdk_user_channel_join'] === null) {
            $invalidProperties[] = "'block_sdk_user_channel_join' can't be null";
        }
     ...
     * Sets user_ids
     *
     * @param int[] $user_ids Specifies an array of one or more IDs of users to invite to the channel. The maximum number of users to be invited at once is 100. The users below and this property can be used interchangeably.
     *
     * @return self
     */
     ...
     * Sets users
     *
     * @param int[] $users Specifies an array of one or more IDs of users to invite to the channel. The maximum number of users to be invited at once is 100. The user_ids above and this property can be used interchangeably.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Specifies the name of the channel, or the channel topic. The length is limited to 191 characters. (Default: group channel)
     *
     * @return self
     */
     ...
     * Sets cover_url
     *
     * @param string $cover_url Specifies the URL of the cover image for the channel. The length is limited to 2,048 characters.
     *
     * @return self
     */
     ...
     * Sets is_distinct
     *
     * @param bool $is_distinct Determines whether to reuse an existing channel or create a new channel. If set to true, returns a channel with the same users in the user_ids or users property or creates a new channel if no match is found. Sendbird server can also use the custom channel type in the custom_type property if specified along with the users to return the corresponding channel. If set to false, Sendbird server always creates a new channel with a combination of the users as well as the channel custom type if specified. (Default: false)<br /><br /> Under this property, Sendbird server does not distinguish channels based on other properties such as channel URL or channel name.
     *
     * @return self
     */
     ...
     * Sets is_super
     *
     * @param bool $is_super Determines whether to allow the channel to accommodate more than 2,000 members. (Default: false) <br/><br/> Supergroup channels are not supported with the is_distinct property and the property is false by default.
     *
     * @return self
     */
     ...
     * Sets is_ephemeral
     *
     * @param bool $is_ephemeral Determines whether to preserve the messages in the channel for the purpose of retrieving chat history. (Default: false)
     *
     * @return self
     */
     ...
     * Sets access_code
     *
     * @param string $access_code This parameter can only be used when the channel operator creates a public group channel. They can set an access code for the corresponding type of channel. The channel then requires the specified access code to a user who attempts to join. If specified, the is_access_code_required property of the channel resource is set to true.
     *
     * @return self
     */
     ...
     * Sets inviter_id
     *
     * @param string $inviter_id Specifies the ID of the user who has invited other users as members of the channel. The inviter is not automatically registered to the channel as a member, so you should specify the ID of the inviter in the user_ids property below if needed.
     *
     * @return self
     */
