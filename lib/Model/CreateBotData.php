 ...
 */
class CreateBotData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createBotData';
     ...
     * Sets bot_userid
     *
     * @param string $bot_userid Specifies the unique ID of the bot. The length is limited to 80 characters.
     *
     * @return self
     */
     ...
     * Sets bot_type
     *
     * @param string $bot_type Specifies the type of the bot that you can specify for categorization. The length is limited to 128 characters.
     *
     * @return self
     */
