...
/**
 * GcBanUserData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class GcBanUserData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gcBanUserData';
     ...
     * Sets channel_url
     *
     * @param string $channel_url Specifies the URL of the channel where to ban a user.
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string $user_id Specifies the unique ID of the user to ban.
     *
     * @return self
     */
     ...
     * Sets agent_id
     *
     * @param string $agent_id Specifies the ID of the agent (operator) who bans the user.
     *
     * @return self
     */
