...
/**
 * MigrateMessagesFileMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class MigrateMessagesFileMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MigrateMessagesFileMessageRequest';
    ...
    public function setCustomType($custom_type)
    {
        if (!is_null($custom_type) && (mb_strlen($custom_type) > 128)) {
            throw new \InvalidArgumentException('invalid length for $custom_type when calling MigrateMessagesFileMessageRequest., must be smaller than or equal to 128.');
        }
