...
/**
 * SendBirdAdminMessage Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class SendBirdAdminMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendBird.AdminMessage';
    ...
    public const SENDING_STATUS_CANCELED = 'canceled';
    public const SENDING_STATUS_FAILED = 'failed';
    public const SENDING_STATUS_NONE = 'none';
    public const SENDING_STATUS_PENDING = 'pending';
    public const SENDING_STATUS_SUCCEEDED = 'succeeded';
