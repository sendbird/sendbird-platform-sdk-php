...
/**
 * AddReactionToAMessageData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class AddReactionToAMessageData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addReactionToAMessageData';
     ...
     * Sets channel_type
     *
     * @param string $channel_type Specifies the type of the channel. Currently, a value of group_channels is only available for the parameter.
     *
     * @return self
     */
     ...
     * Sets message_id
     *
     * @param int $message_id Specifies the unique ID of the message to add a reaction to.
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string $user_id Specifies the ID of the user who reacts to the message.
     *
     * @return self
     */
     ...
     * Sets reaction
     *
     * @param string $reaction Specifies the unique key of the reaction to be added to the message. The length is limited to 192 charaters.
     *
     * @return self
     */
