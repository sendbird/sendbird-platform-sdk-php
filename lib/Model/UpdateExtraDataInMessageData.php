 ...
 */
class UpdateExtraDataInMessageData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateExtraDataInMessageData';
     ...
     * Sets message_id
     *
     * @param int $message_id Specifies the unique ID of the message to update key-values items.
     *
     * @return self
     */
     ...
     * Sets upsert
     *
     * @param bool $upsert Determines whether to add new items in addition to updating existing items. If true, new key-values items are added when there are no items with the keys. The existing items are updated with new values when there are already items with the keys. If false, only the items of which keys match the ones you specify are updated with new values. (Default: false)
     *
     * @return self
     */
