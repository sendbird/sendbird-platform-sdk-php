...
class RegisterGdprRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets user_ids
     *
     * @param string[] $user_ids Specifies an array of the IDs of the users to delete in order to meet the GDPR's requirements. The maximum number of users to be processed at once is 100. This should be specified when the value of the action property is delete.
     *
     * @return self
     */
