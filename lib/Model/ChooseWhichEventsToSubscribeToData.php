 ...
 */
class ChooseWhichEventsToSubscribeToData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chooseWhichEventsToSubscribeToData';
     ...
     * Sets enabled
     *
     * @param bool $enabled Determines whether webhooks are turned on in your Sendbird application or not. (Default: false)
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Specifies the URL of your webhook server to receive payloads for events.
     *
     * @return self
     */
