...
/**
 * GcJoinChannelData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class GcJoinChannelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gcJoinChannelData';
     ...
     * Sets channel_url
     *
     * @param string $channel_url Specifies the URL of the channel to join.
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string $user_id Specifies the unique ID of the user to join the public group channel.
     *
     * @return self
     */
     ...
     * Sets access_code
     *
     * @param string $access_code This property should be specified if the public group channel to join requires an access code to users, which means that the is_access_code_required property of the channel resource is true.
     *
     * @return self
     */
