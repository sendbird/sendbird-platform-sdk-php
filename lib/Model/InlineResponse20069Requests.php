...
/**
 * InlineResponse20069Requests Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20069Requests implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_69_requests';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'user_id' => 'string',
        'files' => '\OpenAPI\Client\Model\InlineResponse20064File',
        'user_ids' => 'string[]',
     ...
     * Sets files
     *
     * @param \OpenAPI\Client\Model\InlineResponse20064File|null $files files
     *
     * @return self
     */
