...
/**
 * AddIpToWhitelistData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class AddIpToWhitelistData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addIpToWhitelistData';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ip_whitelist_addresses'] === null) {
            $invalidProperties[] = "'ip_whitelist_addresses' can't be null";
        }
     ...
     *
     * @param string[] $ip_whitelist_addresses Specifies an array of one or more IP ranges and addresses to add to a whitelist.
     *
     * @return self
     */
