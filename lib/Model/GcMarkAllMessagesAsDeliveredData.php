...
/**
 * GcMarkAllMessagesAsDeliveredData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class GcMarkAllMessagesAsDeliveredData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gcMarkAllMessagesAsDeliveredData';
     ...
     * Sets application_id
     *
     * @param string $application_id Specifies the unique ID of your application.
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string $user_id Specifies the ID of the recipient to mark messages as delivered.
     *
     * @return self
     */
