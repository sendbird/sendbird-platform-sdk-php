...
/**
 * SendBirdSendBirdInstanceBaseChannelMessageTypeFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SendBirdSendBirdInstanceBaseChannelMessageTypeFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendBird_SendBirdInstance_BaseChannel_MessageTypeFilter';
    ...
    const ADMIN_ADMM = 'ADMM';
    const ALL_EMPTY = '';
    const FILE_FILE = 'FILE';
    const USER_MESG = 'MESG';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['file']) && !in_array($this->container['file'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'file', must be one of '%s'",
                $this->container['file'],
                implode("', '", $allowedValues)
            );
        }
