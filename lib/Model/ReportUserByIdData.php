...
/**
 * ReportUserByIdData Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class ReportUserByIdData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reportUserByIdData';
     ...
     *
     * @param string $offending_user_id Specifies the unique ID of the user to report for using offensive or abusive language such as sending explicit messages or inappropriate comments.
     *
     * @return self
     */
     ...
     * Sets channel_url
     *
     * @param string|null $channel_url Specifies the URL of the channel where the user to report is in.
     *
     * @return self
     */
     ...
     *
     * @param string|null $reporting_user_id Specifies the unique ID of the user who reports the offending user.
     *
     * @return self
     */
