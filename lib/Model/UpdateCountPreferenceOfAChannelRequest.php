...
/**
 * UpdateCountPreferenceOfAChannelRequest Class Doc Comment
 *
 * @category Class
 * @package  Sendbird
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCountPreferenceOfAChannelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCountPreferenceOfAChannel_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['count_preference'] === null) {
            $invalidProperties[] = "'count_preference' can't be null";
        }
     ...
     *
     * @param string $count_preference count_preference
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getCountPreferenceAllowableValues();
        if (!in_array($count_preference, $allowedValues, true)) {
