...
*UserApi* | [**createUserToken**](docs/Api/UserApi.md#createusertoken) | **POST** /v3/users/{user_id}/token | Create user token
...
- [CreateUserTokenData](docs/Model/CreateUserTokenData.md)
- [CreateUserTokenResponse](docs/Model/CreateUserTokenResponse.md)
